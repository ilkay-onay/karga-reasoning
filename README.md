# 🐦 Kumru-2B-Reasoning: Turkish SLM with Chain-of-Thought (CoT)

[![Python](https://img.shields.io/badge/python-3.8+-blue.svg)](https://www.python.org/)
[![PyTorch](https://img.shields.io/badge/PyTorch-%23EE4C2C.svg?style=flat&logo=PyTorch&logoColor=white)](https://pytorch.org/)
[![Hugging Face Spaces](https://img.shields.io/badge/🤗%20Hugging%20Face-Live%20Demo-blue)](https://huggingface.co/spaces/ilkayO/Kumru-Reasoning-Demo)
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ilkay-onay/kumru-reasoning/blob/main/notebooks/Kumru_Quickstart.ipynb)

This repository serves as the public showcase and inference codebase for **Kumru-2B-Reasoning**, a 2-Billion parameter Small Language Model (SLM) trained to perform rigorous step-by-step reasoning in Turkish.
...
## 📌 Project Overview
Large Language Models (LLMs) often struggle with complex logic and mathematics, especially in low-resource languages. **Kumru-2B-Reasoning** bridges this gap by bringing **Chain-of-Thought (CoT)** capabilities to Edge-friendly models. 
...
* **Native Turkish CoT:** Unlike English models prompting in Turkish, Kumru structurally thinks and reasons in native Turkish.
...
| Category | Baseline (Original Kumru) | Finetuned (Kumru-Reasoning) | Difference |
| :--- | :--- | :--- | :--- |
...
## 💻 Quick Start
Please refer to the `notebooks/Kumru_Quickstart.ipynb` for a plug-and-play Google Colab experience, or visit the [Hugging Face Model Card](https://huggingface.co/YOUR-HF-USERNAME/Kumru-2B-Reasoning) for Python integration snippets.

## ⚖️ License
* **Source Code:** [GNU GPL v3.0](LICENSE) *(Ensuring open-source integrity for the codebase)*
* **Model Weights:** [Apache 2.0](https://huggingface.co/YOUR-HF-USERNAME/Kumru-2B-Reasoning) *(Commercially permissive for model deployment)*
